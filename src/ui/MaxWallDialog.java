...
public class MaxWallDialog extends JDialog {
    ...
    public MaxWallDialog(Frame owner) {
        ...
        // 0.65x scale to match ClearMapDialog compact size
        float scale = 0.65f;
        int width = Math.round(526 * scale);
        int height = Math.round(474 * scale);
        ...
        int okW = getWidthForHeight(trimmedOK, btnHeight, Math.round(130 * scale));
