...
/**
 * Custom visual popup shown when a map is successfully saved in Design Mode.
 */
public class MapSavedDialog extends JDialog {
    private BufferedImage bgImage;
    private BufferedImage okButtonImage;

    public MapSavedDialog(Frame owner) {
        super(owner, "Map Saved Successfully", true);
        setUndecorated(true);
        setBackground(new Color(0, 0, 0, 0)); // Transparent background

        loadImages();

        // 0.65x scale relative to standard box size (matching MaxObstacleDialog / MaxItemDialog / InvalidMapDialog)
        ...
        // Trim transparent borders from button image
        ...
        // Center the single button horizontally
    ...
    private void loadImages() {
        bgImage = loadImg("resources/images/PopUpImages/MapSavedPopUp.png");
