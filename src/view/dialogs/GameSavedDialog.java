...
/**
 * Custom visual popup shown when the game is successfully saved.
 */
public class GameSavedDialog extends JDialog {
    private BufferedImage bgImage;
    private BufferedImage okButtonImage;

    public GameSavedDialog(Frame owner) {
        super(owner, "Game Saved Successfully", true);
        setUndecorated(true);
        setBackground(new Color(0, 0, 0, 0)); // Transparent background

        loadImages();

        // 0.65x scale relative to standard box size (matching MaxObstacleDialog / MaxItemDialog / MapSavedDialog)
    ...
    private void loadImages() {
        bgImage = loadImg("resources/images/PopUpImages/GameSavedPopUp.png");
