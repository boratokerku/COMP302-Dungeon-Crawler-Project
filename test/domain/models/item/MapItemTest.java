...
public class MapItemTest {
    ...
    public void testManaPotionItemProperties() {
        PotionItem item = new PotionItem(new ManaPotion("Blue Potion", 20), 1, 2, "images/items/potion/blue_potion.png");
    ...
    public void testEnergyPotionItemProperties() {
        PotionItem item = new PotionItem(new EnergyPotion("Green Potion", 30), 9, 9, "images/items/potion/green_potion.png");
    ...
    public void testCreateRandomPotionItem() {
        ...
        assertTrue(pot.getPotion() instanceof HealthPotion || pot.getPotion() instanceof ManaPotion || pot.getPotion() instanceof EnergyPotion);
    }
}
